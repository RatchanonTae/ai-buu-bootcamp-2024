...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "รัชชนนท์ จาระนัย คือ ชายหนุ่มที่มีความสามารถในการเขียนโปรแกรมที่มาจากบริษัท ClickNext ที่เป็นบริษัทด้านการพัฒนาโปรแกรมที่มีชื่อเสียง",
        "รัชชนนท์ จาระนัย มีชื่อเล่นว่า โปเต้ เกิดวันที่ 5 กรกฏาคม 2546 ที่จังหวัดปราจีนบุรี ศึกษาจบจากมหาวิทยาลัยบูรพา สาขาวิศวกรรมคอมพิวเตอร์",
